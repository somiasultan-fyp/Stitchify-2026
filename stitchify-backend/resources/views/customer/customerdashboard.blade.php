...
@endif
  ...
  <div class="main-content">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <p class="stat-label">Saved Tailors</p>
      </div>
    </div>
    ...
    <div class="content-section" id="my-orders">
      ...
      <div class="order-card">
        ...
        <div class="order-details">
          ...
          <p><strong>Item:</strong> Custom 3-Piece Suit</p>
          <p><strong>Order Date:</strong> Jan 15, 2026</p>
          <p><strong>Expected Delivery:</strong> Jan 25, 2026</p>
        </div>
      </div>
      ...
      <div class="order-card">
        ...
        <div class="order-details">
          ...
          <p><strong>Expected Delivery:</strong> Jan 22, 2026</p>
        </div>
      </div>
      ...
      <div class="order-card">
        ...
        <div class="order-details">
          ...
          <p><strong>Item:</strong> Waistcoat</p>
          <p><strong>Order Date:</strong> Jan 10, 2026</p>
          <p><strong>Delivered:</strong> Jan 18, 2026</p>
        </div>
      </div>
    </div>

    <div class="content-section" id="find-tailors">
      <h3 class="section-title">Find Tailors</h3>
      ...
      <div class="tailor-grid">
        <div class="tailor-card">
          ...
          <h4 class="tailor-name">Ahmed Tailors</h4>
          <p class="tailor-specialty">Men's Suits & Formal Wear</p>
        ...
        <div class="tailor-card">
          ...
          <h4 class="tailor-name">Fashion Studio</h4>
          <p class="tailor-specialty">Women's & Bridal Wear</p>
          <div class="tailor-rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <div class="tailor-card">
          ...
          <h4 class="tailor-name">Elite Tailoring</h4>
          <p class="tailor-specialty">All Categories</p>
          <div class="tailor-rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="content-section" id="order-history">
      ...
      <div class="order-card">
        ...
        <div class="order-details">
          <p><strong>Tailor:</strong> Royal Tailors</p>
          <p><strong>Item:</strong> Wedding Sherwani</p>
          <p><strong>Order Date:</strong> Dec 20, 2023</p>
          <p><strong>Delivered:</strong> Dec 28, 2023</p>
        </div>
      </div>

      <div class="order-card">
        <div class="order-header">
          <div class="order-id">#ORD-2023-095</div>
          <span class="order-status status-completed">Completed</span>
        </div>
        <div class="order-details">
          <p><strong>Tailor:</strong> Ahmed Tailors</p>
          <p><strong>Item:</strong> Casual Shirt</p>
          <p><strong>Order Date:</strong> Dec 15, 2023</p>
          <p><strong>Delivered:</strong> Dec 20, 2023</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    // Spy scroll - auto highlight active section
