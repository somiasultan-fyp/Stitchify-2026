...
<body>
    ...
    <section class="hero-section d-flex align-items-center">
        <div class="container">
            ...
            <a href="#categories" class="btn btn-stitchify btn-lg">Explore Now</a>
        </div>
    </section>
        ...
        <div class="container text-center">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-3">
                    ...
                    <p>Select your preferred design, enter fabric details, and 
                        provide your measurements for perfect fit.
                    </p>
                </div>
                <div class="col-md-3">
                    <div class="step-circle">
                ...
                <div class="col-md-3">
                    ...
                    <p>Track your order and recieve your 
                        outfit at your doorstep.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            Register on our website, select your category, upload measurements, and schedule a pickup.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            Delivery charges vary based on your location and the urgency of the order.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            Yes, we will pick up the fabric from your location.
                        </div>
                    </div>
                </div>
