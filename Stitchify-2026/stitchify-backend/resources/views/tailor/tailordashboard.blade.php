        ...
        if (data.notifications && data.notifications.length > 0) {
            list.innerHTML = data.notifications.map(n => `
                <div style="padding:12px 16px; border-bottom:1px solid #f0f0f0;
                            ...
                            background:${n.is_read ? 'white' : '#e8f4fd'}">
            ...
            list.innerHTML = '<div style="padding:25px; text-align:center; color:#aaa; font-size:13px;"><i class="fas fa-check-circle fa-2x mb-2 d-block" style="color:#ccc"></i>No new notifications</div>';
        }
    })
    .catch(() => {});
}
